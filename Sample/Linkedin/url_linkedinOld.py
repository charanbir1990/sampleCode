...
async def gotoOverRide(page, url, time):
    try:
        ...
        raise TypeError("unable to goto utl: {0}".format(url))
...
class NewThread (threading.Thread):
    ...
    async def browser(self,ip):
        try:
            ...
            raise TypeError("unable to launch Browser")
    ...
    async def initPage(self, browser):
        try:
            ...
            await self.browser.close()
            raise TypeError("unable to launch Page")
    ...
    async def handelRequest(self):
        try:
            ...
            except: pass #AssertionError as error: pass
            try:
                await page.close()
                await self.browser.close()
            except: pass #AssertionError as error: pass
    ...
    async def clickWithXpath(self, page, xpath):
        try:
            ...
            raise TypeError("unable to launch click on button")
